...
export function LandingPage({ content }: { content: LandingContent }) {
  return (
    <>
        ...
        <div className="container-editorial py-14 md:py-20">
          ...
          <div className="mt-10 grid gap-px overflow-hidden border border-border bg-border md:mt-14 md:grid-cols-2">
            {content.highlights.map((h) => (
              <div key={h.title} className="bg-card p-6 sm:p-8">
      ...
      <section className="border-b border-border bg-background">
        <div className="container-editorial grid gap-px overflow-hidden border border-border bg-border py-0 md:grid-cols-3">
